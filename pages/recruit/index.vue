        ...
        <div class="job-position">
          <div class="job-type reco-job">
            ...
            <ul class="yui3-g job-list" style="display:block;">
              <li class="yui3-u-1-2 job-item" v-for="(item,index) in recommendList" :key="index"><p>
                <span class="name">
<!--                  <a href="~/assets/recruit-detail.html" target="_blank">{{item.jobname}}</a>-->
                  <nuxt-link :to="'/recruit/item/'+item.id">{{item.jobname}}</nuxt-link>
                </span>
                <span class="city"><i class="fa fa-map-marker"></i> {{item.address}}</span></p>
              ...
              <!--              <li class="yui3-u-1-2 job-item"> <p><span class="name">Python开发工程师</span><span class="city"><i class="fa fa-map-marker"></i> 北京</span></p> <p class="need"><span class="money">15K-25K</span>/经验3-5年/本科及以上/全职</p> <p><span class="company">百度 &middot; 6天前</span></p> </li>-->
              <!--              <li class="yui3-u-1-2 job-item"> <p><span class="name">Python开发工程师</span><span class="city"><i class="fa fa-map-marker"></i> 北京</span></p> <p class="need"><span class="money">15K-25K</span>/经验3-5年/本科及以上/全职</p> <p><span class="company">百度 &middot; 6天前</span></p> </li>-->
              <!--              <li class="yui3-u-1-2 job-item"> <p><span class="name">Python开发工程师</span><span class="city"><i class="fa fa-map-marker"></i> 北京</span></p> <p class="need"><span class="money">15K-25K</span>/经验3-5年/本科及以上/全职</p> <p><span class="company">百度 &middot; 6天前</span></p> </li>-->
            </ul>
          </div>
...
<script>
    ...
    export default {
        asyncData() {
            // 由于页面渲染要一次返回多个多个调用的接口数据,使用axios的all和spread方法调用多个接口,返回多个数据
